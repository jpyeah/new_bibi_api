...
define('USER_AUTH_BLACK_LIST',51009);
define('USER_MOBILE_FORGETPASS',51010);
...
define('CAR_WAITING_CHECK', 60025);
...
//pact car
define('PACT_CAR_NOT_AUTH' , 73001);
define('CONFIRM_PACT_CAR_NOT_ALLOW' , 73002);
define('CONFIRM_PACT_CAR_NOT_NULL' , 73003);
define('SELLER_PACT_CAR_NOT_ALLOW' , 73004);
define('SELLER_PACT_CAR_ENOUGH_MONEY' , 73005);
define('CANCEL_PACT_CAR_ERROR' , 73006);
define('REFUND_PACT_CAR_ERROR' , 73007);
define('REFUND_PACT_CAR_FAIL' , 73008);


//rental car
define('RENTAL_ORDER_NO_EXIT',74001);
define('CREATE_ORDER_ERROR',74002);
define('RENTAL_USER_AUTH_NO_ALOW',74003);
define('RENTAL_CAR_NO_ALLOW',74004);
define('RENTAL_USER_UPLOAD_ERROR',74005);
