 ...
 */
    public function BrandAction()
    {
        ...
        $sql = 'SELECT `brand_id`, `brand_name`, `abbre`, `brand_url` FROM `bibi_new_car_brand_list` WHERE is_hot = 1';
    ...
    public function seriesAction()
    {
        ...
        $sql = 'SELECT `brand_series_id` AS `series_id`, `brand_series_name` AS `series_name` ,`brand_series_url1`,`brand_series_url2` ,`makename`,`series_info`,`max_power`  FROM `bibi_new_car_brand_series` WHERE `brand_id` = ' . $brand_id;
    ...
    public  function  modelAction(){
        ...
        $serie = 'SELECT `brand_series_id` AS `series_id`, `brand_series_name` AS `series_name` ,`brand_series_url1`,`brand_series_url2`,`makename`,`series_info`,`max_power`  FROM `bibi_new_car_brand_series` WHERE `brand_series_id` = ' . $series_id;
