 ...
 * Time: 下午1:30
 */
class FeedThemeModel extends PdoDb
{
    ...
    public function getFeeds($feedId = 0, $type = 0, $userId = 0 ,$page = 1)
    {
        ...
        $sql = '
                 ...
                 t2.user_id, t2.avatar, t2.nickname,t2.type,
            ...
            switch ($type) {
                ...
                case 8:
                    ...
                    $sqlLatest = '
                        ...
                        FROM
                        `bibi_feeds` 
                        WHERE  '.$times.' <= `created` AND feed_type = 1
                        ORDER BY created DESC
                        LIMIT ' . $number . ' , ' . $pageSize . '
                    ';
                    ...
                    $sqlLatestCnt = '
                        ...
                        FROM
                        `bibi_feeds` AS t1
                        WHERE '.$times.' <= `created` AND t1.feed_type = 1
