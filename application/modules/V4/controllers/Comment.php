...
class CommentController extends ApiYafControllerAbstract {
    ...
    /**
     * @api {POST} /v4/Comment/create 添加评论
     ...
     * @apiParam {number} feed_id 朋友圈id/文章id
     * @apiParam {number} content 评论内容
     * @apiParam {number} [father_id] 一级评论的Id
     * @apiParam {number} [reply_id]  评论对象的评论Id
     *
     * @apiParamExample {json} 请求样例
     *   POST /v4/Comment/create
     *   {
     *     "data": {
     *       "device_identifier":"",
     *       "session_id":"",
     ...
     * @apiParam {number} feed_id 朋友圈评论
     *
     * @apiParamExample {json} 请求样例
     *   POST /v4/Comment/list
     *   {
     *     "data": {
     *       "device_identifier":"",
     *       "session_id":"",
    ...
    /**
     * @api {POST} /v4/Comment/getcomment 一级评论下的二级评论列表
     * @apiName comment getcomment
     * @apiGroup Comment
     * @apiDescription 一级评论下的二级评论列表
     * @apiPermission anyone
     * @apiSampleRequest http://testapi.bibicar.cn
     * @apiVersion 2.0.0
     *
     ...
     * @apiParam {number} comment_id 一级评论Id
    ...
    /**
     * @api {POST} /v4/Comment/delete 评论删除
    ...
    /**
     * @api {POST} /v4/Comment/commentlikecreate 评论点赞
     ...
     *
     * @apiParamExample {json} 请求样例
     *   POST /v4/Comment/commentlikecreate
     *   {
     *     "data": {
     *       "device_identifier":"",
     *       "session_id":"",
    ...
    /**
     * @api {POST} /v4/Comment/commentlikedelete 评论点赞取消
     * @apiName delete comment like
     * @apiGroup Comment
     * @apiDescription 评论点赞取消
     * @apiPermission anyone
     * @apiSampleRequest http://testapi.bibicar.cn
     * @apiVersion 2.0.0
     *
     ...
     *
     * @apiParamExample {json} 请求样例
     *   POST /v4/Comment/commentlikedelete
     *   {
     *     "data": {
     *       "device_identifier":"",
     *       "session_id":"",
