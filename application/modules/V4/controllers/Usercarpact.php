...
//           }
    ...
    public  function AlirefundtestAction(){


        $Alipay=new Alipayment();

        $order_sn = "7605404510707341";

        $trade_no = "2017060521001004110291069887";

        $refund_amount = "1";

        $result = $Alipay->alirefund($order_sn,$trade_no,$refund_amount);
...
//                            $Profiles->updateProfileByKey($Pact_Info['buyer_id'],$pro_update);
    ...
    public function testrefundAction(){
        ...
        $result = $this->BuyerRefundMoney(52);
        print_r($result);exit;
    }
