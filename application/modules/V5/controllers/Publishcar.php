...
//        }
    ...
    /**
     * @api {POST} /v5/Publishcar/create  上传二手车
     * @apiName car create
     * @apiGroup Car
     * @apiDescription 上传二手车
    ...
    /**
     * @api {POST} /v5/Publishcar/newCar  上传新车
     * @apiName car newCar
     * @apiGroup Car
     * @apiDescription 上传新车
     * @apiPermission anyone
     ...
     * @apiParam (request) {string} device_identifier 设备唯一标识
     * @apiParam (request) {string} session_id session_id
     * @apiParam (request) {string} file_type 文字说明 车辆照片类型 (1:外观 2:中控内饰 3:发动机及结构 4:更多细节)
     * @apiParam (request) {string} files_id 图片
     * @apiParam (request) {string} car_id 车辆Id
     * @apiParam (request) {number} car_type 车辆类型 0:新车 1:二手车 3:爱车
     *
     *
     */
    ...
    /**
     * @api {POST} /v5/publishcar/getcompanylist 车行列表
    ...
    /**
     * @api {POST} /v5/Publishcar/list 我的售车
     * @apiName Car list
     * @apiGroup Car
     * @apiDescription 我的售车
     * @apiPermission anyone
     ...
     * @apiParam (request) {string} device_identifier 设备唯一标识
     * @apiParam (request) {string} session_id session_id
     * @apiParam (request) {number} [brand_id] 品牌id
     * @apiParam (request) {number} [user_id] 用户id
     * @apiParam (request) {number} [series_id] 系列id
     * @apiParam (request) {number} [type] type类型 1：已售出 2:在售 ,3：在售最新＋已出售 4 所有售车；
     * @apiParam (request) {number} page 页数
     *
     *
     */
